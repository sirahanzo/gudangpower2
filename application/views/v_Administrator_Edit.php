                                        ...
                                        <div class="panel-body">
                                            <form data-toggle="validator" data-disable="false" role="form">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="inputName"  required="" name="username" value="<?php echo $edit->username ?>"> </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo site_url('administrator');?>" type="submit" class="btn btn-warning">CANCEL</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
