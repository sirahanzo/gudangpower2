                                                    ...
                                                    <?php foreach ($parameter13 as $p1): ?>
                                                        <form action="<?php echo site_url('controll/save_controll'); ?>" method="post" id="myform">
                                                            ...
                                                            <tr class="h6">
                                                                ...
                                                                <td class="col-sm-3"><?php //echo $p1->value; ?>
                                                                    <select name="<?php echo 'id[' . $p1->id . '][value]'; ?>" id="inputID" class="form-control">
                                                                        <?php if ($p1->value == 0  ){
                                                                            echo  '<option value="0" >Open</option><option value="1">Close</option> ';
                                                                        }else{
                                                                            echo  '<option value="1">Close</option> <option value="0" >Open</option>';
                                                                        } ?>
                                                                    </select>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <button type="submit" class="btn btn-info btn-xs btn-disable ">WRITE</button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </form>
                                                    ...
                                                    <?php foreach ($parameter23 as $p1): ?>
                                                        <form action="<?php echo site_url('controll/save_controll'); ?>" method="post" id="myform">
                                                            ...
                                                            <tr class="h6">
                                                                ...
                                                                <td class="col-sm-5">
                                                                    <select name="<?php echo 'id[' . $p1->id . '][value]'; ?>" id="inputID" class="form-control">
                                                                        <option value="<?php echo $p1->id; ?>"><?php echo $p1->relay; ?></option>
                                                                        <?php foreach ($relay_map as $rly): ?>
                                                                    	<option value="<?php echo  $rly->id ?>"> <?php echo $rly->name ?></option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </td>
                                                                <td class="col-sm-1"><?php echo $p1->unit ?>
