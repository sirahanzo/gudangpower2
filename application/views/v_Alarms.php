                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Alarms settings</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="form col-sm-6">
                                                <table id="table" class="table table_sortable {sortlist: [[0,0]]} " cellspacing="0" width="100%">
                                                    ...
                                                    <!--alarms-->
                                                    <?php foreach ($alarms1 as $p1): ?>
                                                        <form action="<?php echo site_url('alarms/save_alarms'); ?>" method="post" id="myform">
                                                            <input type="text" class="hide" value="<?php echo $this->uri->segment(2); ?>" name="uri">

                                                            <tr>
                                                                <td class=""><?php echo $p1->name; ?> </td>
                                                                <td class="">
                                                                    <select name="<?php echo 'id[' . $p1->id . '][severity]'; ?>" id="inputID" class="form-control">
                                                                        <?php if ($p1->severity == 'Major'){
                                                                            echo '<option value="Major"> Major</option><option value="Minor">Minor</option>';
                                                                        }else{
                                                                            echo '<option value="Minor">Minor</option><option value="Major"> Major</option>';
                                                                        } ?>
                                                                    </select>
                                                                </td>
                                                                <td class="">
                                                                    <select name="<?php echo 'id[' . $p1->id . '][state]'; ?>" id="inputID" class="form-control">
                                                                        <?php if ($p1->state == '1'){
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <a href="<?php echo site_url('controll/read').'/'.$this->uri->segment(2).'/'.$p1->id ?>" class="btn btn-success btn-xs hide ">READ</a>
