                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Datalog</h3>
                                        </div>
                                        <div class="panel-body">
                                            <div class="container-fluid half-padding">
                                                <div id="buttons"></div>
                                                <form action="<?php echo site_url('logs/data_monitor') ?>" method="post">
                                                    <div class="row">
                                                        <div class="col-md-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div role="alert" class="alert alert-danger">
                    <h4><i class="alert-ico fa fa-fw fa-ban"></i><strong>Delete  Datalog ? &thinsp;</strong></h4>
                </div>
            </div>
            <div class="modal-footer">
                <a href="<?php echo site_url('logs/delete_datalog'); ?>" type="" class="btn btn-primary">Continue</a>
